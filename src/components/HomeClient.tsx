...
import { Calendar, ArrowRight, Shield, Eye, Award, Gavel, Heart, Briefcase, Phone, Mail, MapPin, Clock } from 'lucide-react';
import Navbar from '@/components/Navbar';
import Footer from '@/components/Footer';
import RedThreadLine from '@/components/RedThreadLine';
...
export default function HomeClient({ articles }: HomeClientProps) {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Dynamic Red Thread Progress Line */}
      <RedThreadLine />
      ...
      <section id="home" className="relative min-h-screen flex items-center pt-20 bg-bg-primary overflow-hidden transition-colors duration-300">
        <div className="absolute top-0 right-[10%] w-[1px] h-full bg-burgundy-primary/5 hidden lg:block"></div>
        <div className="absolute top-1/3 left-0 w-32 h-[1px] bg-burgundy-primary/10"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-16 relative z-10">
          <div className="lg:col-span-7 flex flex-col items-start">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 border border-burgundy-primary/10 bg-burgundy-bg rounded-full mb-6">
              <span className="w-1.5 h-1.5 bg-burgundy-primary rounded-full animate-pulse shadow-sm shadow-burgundy-primary"></span>
              <span className="text-[0.6rem] font-sans font-semibold tracking-wider text-burgundy-primary uppercase">
                {t('hero.badge')}
              </span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-text-primary leading-tight mb-6">
              ...
              <span className="text-burgundy-primary relative">
                {t('hero.titleHighlight')}
                <span className="absolute bottom-1 left-0 w-full h-[1px] bg-burgundy-primary"></span>
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                href="/iletisim"
                className="text-xs font-sans font-semibold tracking-widest uppercase px-6 py-3 bg-burgundy-primary text-bg-primary hover:bg-burgundy-secondary transition-all duration-300 rounded-sm shadow-sm"
              >
                {t('hero.ctaContact')}
              </Link>
              <Link 
                href="/faaliyet-alanlari"
                className="text-xs font-sans font-semibold tracking-widest uppercase px-6 py-3 border border-burgundy-primary/30 text-text-primary hover:border-burgundy-primary hover:bg-burgundy-primary/5 transition-all duration-300 rounded-lg"
              >
                {t('hero.ctaPractice')}
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center relative">
            <div className="relative w-80 h-96 md:w-96 md:h-[450px] border border-burgundy-primary/20 p-2 bg-bg-primary shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl dark:shadow-stone-950/50">
              ...
              <div className="absolute -top-1 -right-1 w-4 h-4 border-t-2 border-r-2 border-burgundy-primary"></div>
              <div className="absolute -bottom-1 -left-1 w-4 h-4 border-b-2 border-l-2 border-burgundy-primary"></div>
      ...
      <section className="py-24 bg-bg-primary relative border-t border-burgundy-primary/10 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-72 h-96 md:w-80 md:h-[400px] border border-burgundy-primary/20 p-2 bg-bg-primary shadow-lg rounded-xl">
                <div className="relative w-full h-full">
                  <Image 
            ...
            <div className="lg:col-span-7 flex flex-col items-start">
              ...
              <Link 
                href="/hakkimizda"
                className="text-xs font-sans font-semibold tracking-widest uppercase px-5 py-3 border border-burgundy-primary text-burgundy-primary hover:bg-burgundy-primary hover:text-bg-primary transition-all duration-300 rounded-lg"
              >
                Daha Fazla Bilgi
              </Link>
            </div>
      ...
      <section className="py-24 bg-bg-primary relative border-t border-burgundy-primary/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            ...
            {keyPractices.map((practice) => {
              ...
              return (
                <Link 
                  href="/faaliyet-alanlari"
                  key={practice.id} 
                  className="p-8 border border-burgundy-primary/10 bg-bg-primary hover:border-burgundy-primary/30 hover:shadow-md transition-all duration-300 group flex flex-col items-start relative rounded-xl"
                >
                  ...
                  <span className="text-[0.7rem] font-sans font-semibold tracking-wider text-burgundy-primary uppercase flex items-center gap-1 mt-auto">
          ...
          <div className="text-center">
            <Link 
              href="/faaliyet-alanlari"
              className="text-xs font-sans font-semibold tracking-widest uppercase px-6 py-3 border border-burgundy-primary text-burgundy-primary hover:bg-burgundy-primary hover:text-bg-primary transition-all duration-300 rounded-lg inline-block"
            >
      ...
      <section className="py-24 bg-bg-primary relative border-t border-burgundy-primary/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="text-center">
            <Link 
              href="/makaleler"
              className="text-xs font-sans font-semibold tracking-widest uppercase px-6 py-3 border border-burgundy-primary text-burgundy-primary hover:bg-burgundy-primary hover:text-bg-primary transition-all duration-300 rounded-sm inline-block"
            >
              Tüm Makaleler
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6">
              <span className="text-[0.65rem] font-sans font-semibold tracking-[0.25em] text-burgundy-primary uppercase block">
                {t('contact.badge')}
              </span>
              ...
              <div className="flex flex-col gap-4 text-sm font-light">
                <div className="flex gap-3 items-center">
                  <Phone size={16} className="text-burgundy-primary" />
                  <span>0546 263 8990</span>
                </div>
                <div className="flex gap-3 items-center">
                  <Mail size={16} className="text-burgundy-primary" />
                  <span>info@nedimaslan.av.tr</span>
                </div>
                <div className="flex gap-3 items-start">
                  <MapPin size={16} className="text-burgundy-primary mt-1" />
                ...
                <div className="flex gap-3 items-center mt-2">
                  <a 
                    ...
                    className="w-9 h-9 rounded-full bg-burgundy-primary/10 hover:bg-burgundy-primary hover:text-bg-primary transition-all duration-300 flex items-center justify-center text-burgundy-primary"
                    aria-label="LinkedIn"
                  >
            ...
            <div className="flex flex-col gap-5 w-full">
              <div className="h-64 border border-stone-200/60 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm w-full relative group">
                ...
                <div className="absolute top-4 left-4 bg-bg-primary/95 dark:bg-stone-950/95 backdrop-blur-md border border-stone-200/60 dark:border-white/10 px-3 py-2 rounded-xl shadow-lg flex items-center gap-2 pointer-events-none z-30 transition-all duration-300 group-hover:-translate-y-0.5">
                  <AslanLogo size={18} className="text-burgundy-primary" />
              ...
              <div className="flex justify-start lg:justify-end">
                <Link 
                  href="/iletisim"
                  className="text-[0.65rem] font-sans font-semibold tracking-widest uppercase px-6 py-3.5 bg-burgundy-primary text-bg-primary hover:bg-burgundy-secondary transition-all duration-300 rounded-xl shadow-md cursor-pointer"
                >
